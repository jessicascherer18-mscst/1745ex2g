<%@ Control Language="VB" AutoEventWireup="false" Inherits="jscherer.Ex2GTest1.ex2gTest1View" CodeFile="ex2gTest1View.ascx.vb" %>
...
<div class="dnnForm dnnEdit dnnClear" id="dnnEdit">
    ...
    <fieldset>
        ...
        <div class="dnnFormItem">
            ...
            <asp:textbox id="StateTextBox" runat="server" maxlength="255" />
        </div>

        <div class="dnnFormItem">
            <dnn:label id="plZIP" runat="server" text="ZIP Code:" helptext="Enter your ZIP code." controlname="ZIPTextBox" />
            <asp:textbox id="ZIPTextBox" runat="server" maxlength="255" />
        </div>
        <div class="dnnFormItem">
